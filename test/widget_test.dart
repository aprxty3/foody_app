...
import 'package:test/model/item_model.dart';
import 'package:test/resources/meals_api_provider.dart';
...
final client = MockClient();
  group('testApi', () {
    test('returns Result ItemModel of Seafood List if the http call completes successfully', () async {
      ...
      when(client.get(Uri.parse('https://www.themealdb.com/api/json/v1/1/filter.php?c=Seafood')))
    ...
    test('returns Result ItemModel of Dessert List if the http call completes successfully', () async {
      ...
      when(client.get(Uri.parse('https://www.themealdb.com/api/json/v1/1/filter.php?c=Dessert')))
          .thenAnswer((_) async => http.Response(Meals().toString(), 200));
    ...
    test('returns Result ItemModel of Detail Dessert if the http call completes successfully', () async {
      ...
      when(client.get(Uri.parse('https://www.themealdb.com/api/json/v1/1/lookup.php?i=52893')))
          .thenAnswer((_) async => http.Response(Meals().toString(), 200));
    ...
    test('returns Result ItemModel of Search Pie if the http call completes successfully', () async {
      ...
      when(client.get(Uri.parse('https://www.themealdb.com/api/json/v1/1/search.php?s=Pie')))
          .thenAnswer((_) async => http.Response(Meals().toString(), 200));
